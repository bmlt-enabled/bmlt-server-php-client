...
class Meeting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['temporarily_virtual'] === null) {
            $invalidProperties[] = "'temporarily_virtual' can't be null";
        }
        ...
        if ($this->container['world_id'] === null) {
            $invalidProperties[] = "'world_id' can't be null";
        }
     ...
     *
     * @param bool $temporarily_virtual temporarily_virtual
     *
     * @return self
     */
     ...
     * Sets world_id
     *
     * @param string $world_id world_id
     *
     * @return self
     */
